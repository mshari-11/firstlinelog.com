      ...
      <header className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? "first-line-header py-3 shadow-lg" : "bg-transparent py-5"}`}>
        <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
          <Link to={ROUTE_PATHS.HOME} className="flex items-center gap-3 group">
            <div className="w-20 h-20 overflow-hidden rounded-lg bg-primary/10 flex items-center justify-center border border-primary/20 shadow-inner">
              <img src="/images/first_line_correct_logos_1.jpg" alt="فيرست لاين لوجستيكس" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105 filter brightness-110" />
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 overflow-hidden rounded-lg bg-white/10 flex items-center justify-center shadow-lg">
                  <img src="/images/first_line_correct_logos_1.jpg" alt="First Line" className="w-full h-12 object-cover" />
                </div>
