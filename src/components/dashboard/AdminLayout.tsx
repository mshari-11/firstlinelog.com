...
const adminNavLinks = [
  ...
  {
    name: "السائقين",
    path: ROUTE_PATHS.ADMIN_DRIVERS,
    icon: Users,
    badge: "2,847",
  },
  {
...
export function AdminLayout() {
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-muted/30 flex">
      {/* Sidebar - Desktop */}
      <aside className="hidden lg:flex lg:w-72 lg:flex-col lg:fixed lg:inset-y-0 bg-sidebar text-sidebar-foreground border-l border-sidebar-border">
        {/* Logo */}
        ...
        {sidebarOpen && (
          <>
            ...
            <motion.aside
              ...
              className="fixed inset-y-0 right-0 z-50 w-72 bg-sidebar text-sidebar-foreground lg:hidden"
            >
