...
export const DEFAULT_MODULES: ModuleDefinition[] = [
  ...
  { id: "accounting-components", labelAr: "مكونات المحاسبة",  label: "Accounting Components", group: "finance", icon: "Calculator",   path: "/admin-panel/accounting-components", enabled: true, isCore: false, order: 21, version: "1.0.0", requiredPermission: "finance", features: [] },
  { id: "payout-workflow",      labelAr: "سير عمل الدفعات",  label: "Payout Workflow",       group: "finance", icon: "GitBranch",    path: "/admin-panel/payout-workflow",       enabled: true, isCore: false, order: 22, version: "1.0.0", requiredPermission: "finance", features: [] },
  { id: "bank-alerts",          labelAr: "تنبيهات بنكية",    label: "Bank Alerts",           group: "finance", icon: "Landmark",     path: "/admin-panel/bank-alerts",           enabled: true, isCore: false, order: 23, version: "1.0.0", requiredPermission: "finance", features: [] },
