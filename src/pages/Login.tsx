              ...
              <div className="w-full max-w-sm">
                ...
                {/* Logo */}
                      <div className="text-center mb-8">
                                ...
                                <h1 className="text-2xl font-bold text-white">تسجيل الدخول</h1>h1>
                        {role && (
                ...
                {/* Form */}
                      <form onSubmit={handleLogin} className="bg-gray-900 rounded-2xl p-6 space-y-4 border border-gray-800">
                                ...
                                <div>
                                            <label className="block text-sm text-gray-400 mb-1">البريد الإلكتروني</label>label>
                                            <input
                                                            type="email"
                                                            value={email}
                                ...
                                <div>
                                            <label className="block text-sm text-gray-400 mb-1">كلمة المرور</label>label>
                      ...
                      <div className="bg-red-900/30 border border-red-700 rounded-lg px-4 py-3">
                                    <p className="text-sm text-red-400 text-center">{error}</p>p>
                      </div>div>
                                )}
