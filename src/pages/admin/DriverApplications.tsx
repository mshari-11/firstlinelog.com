    ...
    <div dir="rtl" style={{ padding: "1.5rem", fontFamily: "var(--con-font-arabic)" }}>
      ...
      <div style={{ display: "flex", gap: "0.75rem", marginBottom: "1rem" }}>
        <div style={{ position: "relative", flex: 1 }}>
          ...
          <input className="con-input" placeholder="بحث بالاسم أو الهاتف أو رقم الهوية..." value={search} onChange={e => setSearch(e.target.value)} style={{ paddingRight: 30, width: "100%" }} />
        </div>
