...
// Slug: admin-account-actions | Status: ACTIVE
// To deploy: supabase functions deploy admin-account-actions --project-ref djebhztfewjfyyoortvv
//
...
// Function: admin-account-actions
...
Deno.serve(async (req: Request) => {
  ...
  return new Response(JSON.stringify({ function: 'admin-account-actions', status: 'active' }), {
