...
// Slug: ai-support-system | Status: ACTIVE
// To deploy: supabase functions deploy ai-support-system --project-ref djebhztfewjfyyoortvv
//
...
Deno.serve(async (req: Request) => {
  ...
  return new Response(JSON.stringify({ function: 'ai-support-system', status: 'active' }), {
