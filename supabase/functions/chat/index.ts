...
// Slug: chat | Status: ACTIVE
// To deploy: supabase functions deploy chat --project-ref djebhztfewjfyyoortvv
//
...
Deno.serve(async (req: Request) => {
  ...
  return new Response(JSON.stringify({ function: 'chat', status: 'active' }), {
