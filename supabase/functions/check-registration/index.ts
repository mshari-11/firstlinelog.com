...
// Slug: check-registration | Status: ACTIVE
// To deploy: supabase functions deploy check-registration --project-ref djebhztfewjfyyoortvv
//
...
Deno.serve(async (req: Request) => {
  ...
  return new Response(JSON.stringify({ function: 'check-registration', status: 'active' }), {
