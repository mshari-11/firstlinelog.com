...
// Slug: login | Status: ACTIVE
// To deploy: supabase functions deploy login --project-ref djebhztfewjfyyoortvv
//
...
Deno.serve(async (req: Request) => {
  ...
  return new Response(JSON.stringify({ function: 'login', status: 'active' }), {
