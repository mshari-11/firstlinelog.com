...
// Slug: send-email-otp | Status: ACTIVE
// To deploy: supabase functions deploy send-email-otp --project-ref djebhztfewjfyyoortvv
//
...
Deno.serve(async (req: Request) => {
  ...
  return new Response(JSON.stringify({ function: 'send-email-otp', status: 'active' }), {
