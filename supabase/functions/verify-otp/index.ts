...
// Slug: verify-otp | Status: ACTIVE
// To deploy: supabase functions deploy verify-otp --project-ref djebhztfewjfyyoortvv
//
...
Deno.serve(async (req: Request) => {
  ...
  return new Response(JSON.stringify({ function: 'verify-otp', status: 'active' }), {
