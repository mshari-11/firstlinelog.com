// Supabase Edge Function: verify-registration-otp
// Production source pulled from Supabase on 2026-03-25
// Slug: verify-registration-otp | Status: ACTIVE
// To deploy: supabase functions deploy verify-registration-otp --project-ref djebhztfewjfyyoortvv
//
...
Deno.serve(async (req: Request) => {
  ...
  return new Response(JSON.stringify({ function: 'verify-registration-otp', status: 'active' }), {
