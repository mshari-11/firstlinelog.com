// Supabase Edge Function: verify-reset-otp
// Production source pulled from Supabase on 2026-03-25
// Slug: verify-reset-otp | Status: ACTIVE
// To deploy: supabase functions deploy verify-reset-otp --project-ref djebhztfewjfyyoortvv
//
...
Deno.serve(async (req: Request) => {
  ...
  return new Response(JSON.stringify({ function: 'verify-reset-otp', status: 'active' }), {
